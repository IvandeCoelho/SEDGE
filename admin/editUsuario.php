...
if (isset($_POST['btnAtualizar'])) {
    ...
    echo $nsexo;
    $sql = "UPDATE usuarios SET idUsuario='[value-1]',nomeUsuario='[value-2]',apelidoUsuario='[value-3]',ddnUsuario='[value-4]',sexoUsuario='[value-5]',cpfUsuario='[value-6]',enderecoUsuario='[value-7]',cidadeUsuario='[value-8]',cepUsuario='[value-9]',ufUsuario='[value-10]',emailUsuario='[value-11]',senhaUsuario='[value-12]',conf_senhaUsuario='[value-13]',tipoUsuario='[value-14]' WHERE 1";
}*/
if (!isset($_GET['editUsuario'])) {
    $idUsu           =       mysqli_real_escape_string($conn, $_GET['id']);
    $buscarUsuarioarios = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM usuarios JOIN nivelusuario ON usuarios.fkNivelUsuario = nivelusuario.idNivelUsuario"));
}
?>
...
<form action="home.php?pages=editUsuario.php" method="post">

    <input type="hidden" name="nome" value="<?php echo $buscarUsuarioarios['idUsuario']; ?>">
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingInput" placeholder="Nome" name="nome"
                    value="<?php echo $buscarUsuarioarios['nomeUsuario']; ?>">
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingInput" placeholder="apelido" name="apelido"
                    value="<?php echo $buscarUsuarioarios['apelidoUsuario']; ?>">
        ...
        <div class="col-md-4 mb-3">
            <div class="form-floating">
                <input type="date" class="form-control" id="floatingInput" placeholder="Data de Nascimento" name="ddn"
                    value="<?php echo $buscarUsuarioarios['ddnUsuario']; ?>">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="text" class="form-control" id="cpf" placeholder="CPF" name="cpf" min="1"
                    value="<?php echo $buscarUsuarioarios['cpfUsuario']; ?>">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <select class="form-select" aria-label="Default select example" name="sexo">
                    <option selected disabled value="<?php echo $buscarUsuarioarios['sexoUsuario'] ?>">
                        <?php echo $buscarUsuarioarios['sexoUsuario'] ?>
                    </option>
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingInput" placeholder="Cidade" name="cidade"
                    value="<?php echo $buscarUsuarioarios['cidadeUsuario']; ?>">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="form-floating">
                <select class="form-select" aria-label="Default select example" name="uf">
                    <option selected disabled value="<?php echo $buscarUsuarioarios['ufUsuario']; ?>">
                        <?php echo $buscarUsuarioarios['ufUsuario']; ?>
                    </option>
        ...
        <div class="col-md-2 mb-3">
            <div class="form-floating">
                <input type="text" class="form-control" id="cep" placeholder="CEP" name="cep" min="1"
                    value="<?php echo $buscarUsuarioarios['cepUsuario']; ?>">
        ...
        <div class="col-md-12 mb-3">
            <div class="form-floating">
                <input type="email" class="form-control" id="floatingInput" placeholder="email" name="email"
                    value="<?php echo $buscarUsuarioarios['emailUsuario']; ?>">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                ...
                <input type="password" class="form-control" id="floatingPassword" name="pass" placeholder="Senha"
                    ...
                    value="<?php echo $buscarUsuarioarios['senhaUsuario']; ?>">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-floating">
                <input type="password" class="form-control" id="floatingPassword2" placeholder="Confirme a senha"
                    name="pass_conf" onkeyup="validatePassword()"
                    value="<?php echo $buscarUsuarioarios['confSenhaUsuario']; ?>">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            ...
            <div class="form-floating">
                <select class="form-select" aria-label="Default select example" name="tipoUsuarioario">

                    <option disabled selected> Selecione o nivel do usuario
                    </option>

                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="home.php" class="dropdown-item">
                                ...
                                Home</a></li>
                        <!-- <a href="home.php?pages=usuarios.php" class="dropdown-item">
                        ...
                        <li>
                            ...
                            <a href="home.php?pages=usuarios.php" class="dropdown-item">
                                ...
                                Usuarios<span style="float: right;">&raquo;</span></a>

                            <ul class=" submenu dropdown-menu">
                                <li><a href="home.php?pages=listaContato.php" class="dropdown-item">
                        ...
                        <li>
                            <a href="home.php?pages=visitaTecnica.php" class="dropdown-item">
